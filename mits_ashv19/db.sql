...
CREATE TABLE `ashv_cse_events` (
 ...
 `events_quiz` int(11) NOT NULL DEFAULT '0',
 ...
 `events_flash` int(11) NOT NULL DEFAULT '0',
 `events_dance` int(11) NOT NULL DEFAULT '0',
 `events_treasure` int(11) NOT NULL DEFAULT '0',
 `events_slowbike` int(11) NOT NULL DEFAULT '0',
 `events_larynx` int(11) NOT NULL DEFAULT '0',
 `events_dancewance` int(11) NOT NULL DEFAULT '0',
 `events_picorama` int(11) NOT NULL DEFAULT '0',
